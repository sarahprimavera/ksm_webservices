              ...
              <div>
                ...
                if (!empty($data)) {
                  foreach ($data as $raw) {
                    ...
                    echo '<td style="border: 0; font-weight: bold;">English → French</td>';
                    echo '<tr>';
                    echo "<td style='border: 0;'> $raw->original_language </td>";
                    echo '</tr>';
                    echo "<td style='border: 0;'> $raw->translated_language </td>";
